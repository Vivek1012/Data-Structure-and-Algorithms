...
public class Prims {
	...
	public static void showPrimsPath(Graph vertex)
	{
		...
		while(vertex.Heap.length > 0)
		{
			...
			while(j < vertex.AdjList[i].size()) {
				...
				int weight = vertex.WgtList[i].get(j);
		...
		System.out.println("The path from source to destination node is = 0 " + nodetrack);
